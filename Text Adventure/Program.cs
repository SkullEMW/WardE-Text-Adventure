    ...
    internal class Game
    {
        ...
        static void KeepMoving()
        {
            ...
            else if (string.Compare(choice3, "Set up camp", true) == 0) 
            {
                ...
                if (string.Compare(choice5, "Put the fire out", true) == 0) // Death
                {
                ...
                else if (string.Compare(choice5, "Keep fire going", true) == 0) // Sloan Cameron introduction path 
                {
                    ...
                    if (string.Compare(choice6, "Take offer", true) == 0) // Win
                    {
                    ...
                    // Refuse offer branch 
                    else if (string.Compare(choice6, "Refuse offer", true) == 0) // Win
                    {
                ...
                if (string.Compare(choice7, "Talk", true) == 0)
                {
                    ...
                    if (string.Compare(choice8, "Aid", true) == 0)
                    {
                        ...
                        if (Medicine <= 12) // Roll Fail
                        {
                            ...
                            if (string.Compare(choice9, "Leave the boy", true) == 0)
                            {
                                WriteByLetter("\"The more you walk, the exhausion only increased. You settle with the idea of lying down for a moment. So that you did. You kneeled down, pat the ground and curled up. \\r\\n\\r\\nAs the night passed, infected had found your passed out body and you were consumed by magic.");
                                Console.WriteLine();
                                Thread.Sleep(1000);
                            ...
                            else if (string.Compare(choice9, "Help the boy", true) == 0) // Win
                            {
