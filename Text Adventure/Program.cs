    ...
    internal class Program
    {
        ...
        static void ChoiceOne()
        {
            ...
            static void Tavern()
            {
                ...
                if (string.Compare(choice, "Tavern", true) == 0)
                {
                    Console.WriteLine();
            ...
            static void KeepMoving()
            {
                ...
                if (string.Compare(choice, "Keep Moving", true) == 0)
                {
                    Console.WriteLine();
                    ...
                    if (choice == "Continue Moving")
                    {
                        Console.WriteLine(DeathOne);
                        Thread.Sleep(1000);
                        Console.WriteLine(gameOver);
                    }
                    else if (choice == "Set up camp")
                    {
            ...
            static void Cabin()
            { 
                if (string.Compare(choice, "Cabin", true) == 0)
                {
                ...
                if (choice == "Enter cabin")
                    {

                    }
                    else if (choice == "Look inside")
                    {

                    }
                    else if (choice == "Leave cabin")
                    {
